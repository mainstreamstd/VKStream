...
public class Api {
    ...
    public ArrayList<Audio> getAudio(Long uid, Long gid, Long album_id, Collection<Long> aids, int offset, int count) throws MalformedURLException, IOException, JSONException, KException{
    ...
    public ArrayList<Audio> searchAudio(String q, String sort, String lyrics, Long count, Long offset, String capchaSid, String capchaKey) throws MalformedURLException, IOException, JSONException, KException{
        ...
        params.put("captcha_sid",capchaSid);
        params.put("captcha_key", capchaKey);
        JSONObject root = sendRequest(params);
        JSONArray array = root.optJSONArray("response");
    ...
    public ArrayList<Video> searchVideo(String q, String sort, String hd, Long count, Long offset) throws MalformedURLException, IOException, JSONException, KException {
        ...
        if(video_ids == "" || video_ids == null) return null;
